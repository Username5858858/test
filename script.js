...
! function(i) {
    ...
    (o = 0, r = function(i, e) {
        ...
        s.unload(), "number" == typeof e ? 0 === e && 0 === s.$slides.length ? a(i).appendTo(s.$slideTrack) : t ? a(i).insertBefore(s.$slides.eq(e)) : a(i).insertAfter(s.$slides.eq(e)) : !0 === t ? a(i).prependTo(s.$slideTrack) : a(i).appendTo(s.$slideTrack), s.$slides = s.$slideTrack.children(this.options.slide), s.$slideTrack.children(this.options.slide).detach(), s.$slideTrack.append(s.$slides), s.$slides.each(function(i, e) {
        ...
        s.animateHeight(), !0 === s.options.rtl && !1 === s.options.vertical && (i = -i), !1 === s.transformsEnabled ? !1 === s.options.vertical ? s.$slideTrack.animate({
            ...
            top: i
        }, s.options.speed, s.options.easing, e) : !1 === s.cssTransitions ? (!0 === s.options.rtl && (s.currentLeft = -s.currentLeft), a({
        ...
        if (s = document.createDocumentFragment(), n = l.$slider.children(), 1 < l.options.rows) {
            for (r = l.options.slidesPerRow * l.options.rows, o = Math.ceil(n.length / r), i = 0; i < o; i++) {
        ...
        if ("window" === n.respondTo ? o = d : "slider" === n.respondTo ? o = l : "min" === n.respondTo && (o = Math.min(d, l)), n.options.responsive && n.options.responsive.length && null !== n.options.responsive) {
            ...
            null !== s ? null !== n.activeBreakpoint ? (s !== n.activeBreakpoint || e) && (n.activeBreakpoint = s, "unslick" === n.breakpointSettings[s] ? n.unslick(s) : (n.options = a.extend({}, n.originalSettings, n.breakpointSettings[s]), !0 === i && (n.currentSlide = n.options.initialSlide), n.refresh(i)), r = s) : (n.activeBreakpoint = s, "unslick" === n.breakpointSettings[s] ? n.unslick(s) : (n.options = a.extend({}, n.originalSettings, n.breakpointSettings[s]), !0 === i && (n.currentSlide = n.options.initialSlide), n.refresh(i)), r = s) : null !== n.activeBreakpoint && (n.activeBreakpoint = null, n.options = n.originalSettings, !0 === i && (n.currentSlide = n.options.initialSlide), n.refresh(i), r = s), i || !1 === r || n.$slider.trigger("breakpoint", [n, r])
        }
        ...
        switch (n.is("a") && i.preventDefault(), n.is("li") || (n = n.closest("li")), t = o.slideCount % o.options.slidesToScroll != 0 ? 0 : (o.slideCount - o.currentSlide) % o.options.slidesToScroll, i.data.message) {
            ...
            case "next":
                ...
                break;
            case "index":
                var r = 0 === i.data.index ? 0 : i.data.index || n.index() * o.options.slidesToScroll;
        ...
        var e, t, s, o, n = this,
            r = 0;
        return n.slideOffset = 0, t = n.$slides.first().outerHeight(!0), !0 === n.options.infinite ? (n.slideCount > n.options.slidesToShow && (n.slideOffset = n.slideWidth * n.options.slidesToShow * -1, o = -1, !0 === n.options.vertical && !0 === n.options.centerMode && (2 === n.options.slidesToShow ? o = -1.5 : 1 === n.options.slidesToShow && (o = -2)), r = t * n.options.slidesToShow * o), n.slideCount % n.options.slidesToScroll != 0 && i + n.options.slidesToScroll > n.slideCount && n.slideCount > n.options.slidesToShow && (i > n.slideCount ? (n.slideOffset = (n.options.slidesToShow - (i - n.slideCount)) * n.slideWidth * -1, r = (n.options.slidesToShow - (i - n.slideCount)) * t * -1) : (n.slideOffset = n.slideCount % n.options.slidesToScroll * n.slideWidth * -1, r = n.slideCount % n.options.slidesToScroll * t * -1))) : i + n.options.slidesToShow > n.slideCount && (n.slideOffset = (i + n.options.slidesToShow - n.slideCount) * n.slideWidth, r = (i + n.options.slidesToShow - n.slideCount) * t), n.slideCount <= n.options.slidesToShow && (r = n.slideOffset = 0), !0 === n.options.centerMode && n.slideCount <= n.options.slidesToShow ? n.slideOffset = n.slideWidth * Math.floor(n.options.slidesToShow) / 2 - n.slideWidth * n.slideCount / 2 : !0 === n.options.centerMode && !0 === n.options.infinite ? n.slideOffset += n.slideWidth * Math.floor(n.options.slidesToShow / 2) - n.slideWidth : !0 === n.options.centerMode && (n.slideOffset = 0, n.slideOffset += n.slideWidth * Math.floor(n.options.slidesToShow / 2)), e = !1 === n.options.vertical ? i * n.slideWidth * -1 + n.slideOffset : i * t * -1 + r, !0 === n.options.variableWidth && (s = n.slideCount <= n.options.slidesToShow || !1 === n.options.infinite ? n.$slideTrack.children(".slick-slide").eq(i) : n.$slideTrack.children(".slick-slide").eq(i + n.options.slidesToShow), e = !0 === n.options.rtl ? s[0] ? -1 * (n.$slideTrack.width() - s[0].offsetLeft - s.width()) : 0 : s[0] ? -1 * s[0].offsetLeft : 0, !0 === n.options.centerMode && (s = n.slideCount <= n.options.slidesToShow || !1 === n.options.infinite ? n.$slideTrack.children(".slick-slide").eq(i) : n.$slideTrack.children(".slick-slide").eq(i + n.options.slidesToShow + 1), e = !0 === n.options.rtl ? s[0] ? -1 * (n.$slideTrack.width() - s[0].offsetLeft - s.width()) : 0 : s[0] ? -1 * s[0].offsetLeft : 0, e += (n.$list.width() - s.outerWidth()) / 2)), e
        ...
        var i, e = this,
            ...
            s = 0,
            o = [];
        for (!1 === e.options.infinite ? i = e.slideCount : (t = -1 * e.options.slidesToScroll, s = -1 * e.options.slidesToScroll, i = 2 * e.slideCount); t < i;) o.push(t), t = s + e.options.slidesToScroll, s += e.options.slidesToScroll <= e.options.slidesToShow ? e.options.slidesToScroll : e.options.slidesToShow;
        return o
    }, r.prototype.getSlick = function() {
        return this
    }, r.prototype.getSlideCount = function() {
        var t, s, o = this;
        return s = !0 === o.options.centerMode ? o.slideWidth * Math.floor(o.options.slidesToShow / 2) : 0, !0 === o.options.swipeToSlide ? (o.$slideTrack.find(".slick-slide").each(function(i, e) {
        ...
        function i(i) {
            a("img[data-lazy]", i).each(function() {
                var i = a(this),
                    ...
                    s = a(this).attr("data-sizes") || n.$slider.attr("data-sizes"),
        ...
        var e, t, s, n = this;
        if (!0 === n.options.centerMode ? !0 === n.options.infinite ? s = (t = n.currentSlide + (n.options.slidesToShow / 2 + 1)) + n.options.slidesToShow + 2 : (t = Math.max(0, n.currentSlide - (n.options.slidesToShow / 2 + 1)), s = n.options.slidesToShow / 2 + 1 + 2 + n.currentSlide) : (t = n.options.infinite ? n.options.slidesToShow + n.currentSlide : n.currentSlide, s = Math.ceil(t + n.options.slidesToShow), !0 === n.options.fade && (0 < t && t--, s <= n.slideCount && s++)), e = n.$slider.find(".slick-slide").slice(t, s), "anticipated" === n.options.lazyLoad)
            for (var o = t - 1, r = s, l = n.$slider.find(".slick-slide"), d = 0; d < n.options.slidesToScroll; d++) o < 0 && (o = n.slideCount - 1), e = (e = e.add(l.eq(o))).add(l.eq(r)), o--, r++;
        ...
        l.length ? (e = l.first(), t = e.attr("data-lazy"), s = e.attr("data-srcset"), o = e.attr("data-sizes") || r.$slider.attr("data-sizes"), (n = document.createElement("img")).onload = function() {
            s && (e.attr("srcset", s), o && e.attr("sizes", o)), e.attr("src", t).removeAttr("data-lazy data-srcset data-sizes").removeClass("slick-loading"), !0 === r.options.adaptiveHeight && r.setPosition(), r.$slider.trigger("lazyLoaded", [r, e, t]), r.progressiveLazyLoad()
        }, n.onerror = function() {
        ...
        var e, t, s = this;
        t = s.slideCount - s.options.slidesToShow, !s.options.infinite && s.currentSlide > t && (s.currentSlide = t), s.slideCount <= s.options.slidesToShow && (s.currentSlide = 0), e = s.currentSlide, s.destroy(!0), a.extend(s, s.initials, {
            currentSlide: e
        ...
        s.$slides.each(function(i, e) {
            t = s.slideWidth * i * -1, !0 === s.options.rtl ? a(e).css({
                position: "relative",
                right: t,
                top: 0,
        ...
        var i, e, t, s, o, n = this,
            r = !1;
        if ("object" === a.type(arguments[0]) ? (t = arguments[0], r = arguments[1], o = "multiple") : "string" === a.type(arguments[0]) && (t = arguments[0], s = arguments[1], r = arguments[2], "responsive" === arguments[0] && "array" === a.type(arguments[1]) ? o = "responsive" : void 0 !== arguments[1] && (o = "single")), "single" === o) n.options[t] = s;
        else if ("multiple" === o) a.each(t, function(i, e) {
            n.options[i] = e
        });
        else if ("responsive" === o)
            for (e in s)
                if ("array" !== a.type(n.options.responsive)) n.options.responsive = [s[e]];
                else {
        ...
        if (t = n.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-hidden", "true"), n.$slides.eq(i).addClass("slick-current"), !0 === n.options.centerMode) {
            ...
            e = Math.floor(n.options.slidesToShow / 2), !0 === n.options.infinite && (e <= i && i <= n.slideCount - 1 - e ? n.$slides.slice(i - e + r, i + e + 1).addClass("slick-active").attr("aria-hidden", "false") : (s = n.options.slidesToShow + i, t.slice(s - e + 1 + r, s + e + 2).addClass("slick-active").attr("aria-hidden", "false")), 0 === i ? t.eq(t.length - 1 - n.options.slidesToShow).addClass("slick-center") : i === n.slideCount - 1 && t.eq(n.options.slidesToShow).addClass("slick-center")), n.$slides.eq(i).addClass("slick-center")
        } else 0 <= i && i <= n.slideCount - n.options.slidesToShow ? n.$slides.slice(i, i + n.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : t.length <= n.options.slidesToShow ? t.addClass("slick-active").attr("aria-hidden", "false") : (o = n.slideCount % n.options.slidesToShow, s = !0 === n.options.infinite ? n.options.slidesToShow + i : i, n.options.slidesToShow == n.options.slidesToScroll && n.slideCount - i < n.options.slidesToShow ? t.slice(s - (n.options.slidesToShow - o), s + o).addClass("slick-active").attr("aria-hidden", "false") : t.slice(s, s + n.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false"));
        "ondemand" !== n.options.lazyLoad && "anticipated" !== n.options.lazyLoad || n.lazyLoad()
    }, r.prototype.setupInfinite = function() {
        var i, e, t, s = this;
        if (!0 === s.options.fade && (s.options.centerMode = !1), !0 === s.options.infinite && !1 === s.options.fade && (e = null, s.slideCount > s.options.slidesToShow)) {
            for (t = !0 === s.options.centerMode ? s.options.slidesToShow + 1 : s.options.slidesToShow, i = s.slideCount; i > s.slideCount - t; i -= 1) e = i - 1, a(s.$slides[e]).clone(!0).attr("id", "").attr("data-slick-index", e - s.slideCount).prependTo(s.$slideTrack).addClass("slick-cloned");
            for (i = 0; i < t + s.slideCount; i += 1) e = i, a(s.$slides[e]).clone(!0).attr("id", "").attr("data-slick-index", e + s.slideCount).appendTo(s.$slideTrack).addClass("slick-cloned");
        ...
        var i, e, t, s, o = this;
        return i = o.touchObject.startX - o.touchObject.curX, e = o.touchObject.startY - o.touchObject.curY, t = Math.atan2(e, i), (s = Math.round(180 * t / Math.PI)) < 0 && (s = 360 - Math.abs(s)), s <= 45 && 0 <= s ? !1 === o.options.rtl ? "left" : "right" : s <= 360 && 315 <= s ? !1 === o.options.rtl ? "left" : "right" : 135 <= s && s <= 225 ? !1 === o.options.rtl ? "right" : "left" : !0 === o.options.verticalSwiping ? 35 <= s && s <= 135 ? "down" : "up" : "vertical"
        ...
        var i, e, t = this,
            ...
            n = t.length;
        for (i = 0; i < n; i++)
            if ("object" == typeof s || void 0 === s ? t[i].slick = new r(t[i], s) : e = t[i].slick[s].apply(t[i].slick, o), void 0 !== e) return e;
        return t
    }
}),
function(i) {
    ITL.Modules.CustomerSlider = {
        init: function() {
            i(".customer-slider").not(".slick-initialized").slick({
                autoplay: !1,
                autoplaySpeed: 3500,
                arrows: !0,
                dots: !1,
    ...
    }, ITL.Modules.CustomerSlider.init()
}(jQuery),
function(t) {
    ITL.Modules.HeaderSlider = {
        init: function() {
            t(".header-slider").not(".slick-initialized").slick({
                autoplay: !1,
                autoplaySpeed: 3500,
                speed: 500,
                fade: !0,
                ...
                dots: !0,
                customPaging: function(i, e) {
                    return '<button class="tab">' + t(i.$slides[e]).attr("title") + "</button>"
                },
                appendDots: t(".header-slider-dots-container"),
    ...
    }, ITL.Modules.HeaderSlider.init()
}(jQuery),
function(i) {
    ITL.Modules.PackagingSlider = {
        init: function() {
            i(".packaging-slider").not(".slick-initialized").slick({
                autoplay: !1,
                autoplaySpeed: 3500,
                arrows: !0,
                dots: !1,
    ...
    }, ITL.Modules.PackagingSlider.init()
}(jQuery),
function(i) {
    ITL.Modules.ReferenceSlider = {
        init: function() {
            i(".reference-slider").not(".slick-initialized").slick({
                autoplay: !1,
                autoplaySpeed: 3500,
                arrows: !0,
                dots: !1,
    ...
    }, ITL.Modules.ReferenceSlider.init()
}(jQuery),
function(r) {
    ITL.Modules.ResizeIntroSlides = {
        init: function() {
            var t = this,
                s = r(".js--resize-intro-slider").find('*[data-image-slider="true"]'),
                o = s.find(".image-slider--item");
            o.first().addClass("is-active"), r(window).load(function() {
                var i = s.find(".image-slider--item").first().find(".dig-pub").height();
                s.height(i)
            }), r.subscribe("plugin/swImageSlider/onSlideNext", function() {
                t.checkSlide("next", o, s)
            }), r.subscribe("plugin/swImageSlider/onSlidePrev", function() {
                t.checkSlide("prev", o, s)
            }), r.subscribe("plugin/swImageSlider/onSetActiveDot", function() {
                var i = s.find(".dot--link.is--active").index(),
                    e = o.eq(i);
                o.removeClass("is-active"), e.addClass("is-active"), t.checkSlide("next", o, s)
            })
        },
        checkSlide: function(i, e, t) {
            var s = t.find(".image-slider--item.is-active"),
                o = s.find(".layer--content").outerHeight(),
                n = s.find(".dig-pub").height();
            r(window).width() < 768 ? this.resizeSlider(t, n) : this.resizeSlider(t, o)
        },
        resizeSlider: function(i, e) {
            i.height(e)
        }
    }, ITL.Modules.ResizeIntroSlides.init()
}(jQuery),
function(i) {
    ITL.Modules.ResizeSlides = {
        init: function() {
            var t = this,
                s = i(".js--resize-slider .emotion--row").find('*[data-image-slider="true"]'),
                o = s.find(".image-slider--item");
            o.first().addClass("is-active"), i(window).load(function() {
                var i = s.find(".image-slider--item").first().find(".dig-pub").height();
                s.height(i)
            }), i.subscribe("plugin/swImageSlider/onSlideNext", function() {
                t.checkSlide("next", o, s)
            }), i.subscribe("plugin/swImageSlider/onSlidePrev", function() {
                t.checkSlide("prev", o, s)
            }), i.subscribe("plugin/swImageSlider/onSetActiveDot", function() {
                var i = s.find(".dot--link.is--active").index(),
                    e = o.eq(i);
                o.removeClass("is-active"), e.addClass("is-active"), t.checkSlide("next", o, s)
            })
        ...
        checkSlide: function(i, e, t) {
            var s = t.find(".image-slider--item.is-active").find(".dig-pub").height();
            this.resizeSlider(t, s)
        },
        resizeSlider: function(i, e) {
            i.height(e)
        }
    }, ITL.Modules.ResizeSlides.init()
}(jQuery);
